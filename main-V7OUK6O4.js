import "./chunk-FJNLWDLG.js";
import {
  I18n,
  I18nModule
} from "./chunk-FGSO232M.js";
import {
  BaseIconButton,
  ButtonModule,
  IconButton,
...
var appRoutes = [
  {
    path: "home",
    loadComponent: () => import("./chunk-W4O2XHKG.js").then((m) => m.HomeComponent)
  },
  {
    path: "species/:speciesId",
    loadComponent: () => import("./chunk-LNVVSDQV.js").then((m) => m.SpeciesPageComponent)
  },
  {
    path: "**",
    pathMatch: "full",
...
// src/app/dui-templates.service.ts
var _httpClient, _appBaseHref;
var _DUITemplatesService = class _DUITemplatesService {
  constructor() {
    __privateAdd(this, _httpClient);
    __privateAdd(this, _appBaseHref);
    __privateSet(this, _httpClient, inject(HttpClient));
    __privateSet(this, _appBaseHref, inject(APP_BASE_HREF, { optional: true }) ?? "");
    this.getLayoutTemplate = (id) => __privateGet(this, _httpClient).get(`${__privateGet(this, _appBaseHref)}dui-assets/layout-templates/${id}.json`);
    this.getUiElementTemplate = (id) => __privateGet(this, _httpClient).get(`${__privateGet(this, _appBaseHref)}dui-assets/ui-element-templates/${id}.json`);
    this.getRemoteResourceTemplate = (id) => __privateGet(this, _httpClient).get(`${__privateGet(this, _appBaseHref)}dui-assets/remote-resource-templates/${id}.json`);
  }
};
_httpClient = new WeakMap();
_appBaseHref = new WeakMap();
_DUITemplatesService.\u0275fac = function DUITemplatesService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DUITemplatesService)();
};
_DUITemplatesService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DUITemplatesService, factory: _DUITemplatesService.\u0275fac, providedIn: "root" });
var DUITemplatesService = _DUITemplatesService;

// node_modules/.pnpm/carbon-components-angular@5.40.2_@carbon+styles@1.65.0_sass@1.78.0_/node_modules/carbon-components-angular/fesm2020/carbon-components-angular-layer.mjs
var MAX_LEVEL = 2;
...
LayerDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  type: LayerDirective,
...
LayerModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: LayerModule
});
LayerModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
// node_modules/.pnpm/carbon-components-angular@5.40.2_@carbon+styles@1.65.0_sass@1.78.0_/node_modules/carbon-components-angular/fesm2020/carbon-components-angular-theme.mjs
...
ThemeDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  type: ThemeDirective,
...
ThemeModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: ThemeModule
});
ThemeModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
// node_modules/.pnpm/carbon-components-angular@5.40.2_@carbon+styles@1.65.0_sass@1.78.0_/node_modules/carbon-components-angular/fesm2020/carbon-components-angular-ui-shell.mjs
var import_lodash = __toESM(require_lodash(), 1);
var _c0 = [[["cds-hamburger"], ["ibm-hamburger"]], "*"];
var _c1 = ["cds-hamburger,ibm-hamburger", "*"];
...
function Header_ng_container_4_a_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r0.brand, "\xA0");
    \u0275\u0275advance();
...
var _c4 = () => ["cds--header__menu-item--current"];
...
function HeaderItem_a_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(3, _c3, ctx_r1.isCurrentPage))("href", ctx_r1.href, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
...
function HeaderItem_a_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    const content_r3 = \u0275\u0275reference(2);
    \u0275\u0275property("routerLinkActive", \u0275\u0275pureFunction0(5, _c4))("ngClass", \u0275\u0275pureFunction1(6, _c3, ctx_r1.isCurrentPage))("routerLink", ctx_r1.route)("routerLinkActive", ctx_r1.activeLinkClass);
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", content_r3);
  }
}
...
function SideNavItem_a_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(5, _c10, ctx_r1.active))("href", ctx_r1.href, \u0275\u0275sanitizeUrl);
...
var _c13 = [[["cds-sidenav-header"], ["ibm-sidenav-header"]], "*"];
var _c14 = ["cds-sidenav-header,ibm-sidenav-header", "*"];
...
Header.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: Header,
...
HeaderItem.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: HeaderItem,
...
HeaderMenu.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: HeaderMenu,
...
HeaderNavigation.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
HeaderGlobal.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: HeaderGlobal,
...
HeaderAction.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: HeaderAction,
  ...
  template: function HeaderAction_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("buttonNgClass", \u0275\u0275pureFunction1(10, _c5, ctx.active))("align", ctx.align)("caret", ctx.caret)("dropShadow", ctx.dropShadow)("highContrast", ctx.highContrast)("isOpen", ctx.isOpen)("enterDelayMs", ctx.enterDelayMs)("leaveDelayMs", ctx.leaveDelayMs)("description", ctx.description)("buttonAttributes", \u0275\u0275pureFunction1(12, _c6, ctx.ariaLabel));
    }
  },
...
Hamburger.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: Hamburger,
  ...
  template: function Hamburger_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(5, _c7, ctx.active));
...
HeaderModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: HeaderModule
});
HeaderModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
var RouterLinkExtendedDirective = class extends RouterLink {
  ngOnChanges(changes) {
    if (changes.routeExtras && this.routeExtras) {
      (0, import_lodash.keys)(this.routeExtras).forEach((routeExtraProperty) => this[routeExtraProperty] = this.routeExtras[routeExtraProperty]);
    }
...
RouterLinkExtendedDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
SideNavItem.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: SideNavItem,
...
SideNavMenu.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: SideNavMenu,
...
SideNav.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: SideNav,
...
SideNavModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: SideNavModule
});
SideNavModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
Panel.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: Panel,
  ...
  template: function Panel_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c15, ctx.expanded));
      \u0275\u0275attribute("aria-label", ctx.ariaLabel);
    }
  },
...
SwitcherList.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: SwitcherList,
...
SwitcherListItem.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  template: function SwitcherListItem_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(3, _c16, ctx.active))("href", ctx.href, \u0275\u0275sanitizeUrl)("target", ctx.target);
    }
  },
  dependencies: [NgClass],
  encapsulation: 2
...
PanelModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: PanelModule
});
PanelModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
UIShellModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: UIShellModule
});
UIShellModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
// node_modules/.pnpm/@namnguyen191+dui-carbon-components@0.0.0-7_@angular+common@18.2.4_@angular+core@18.2.4_rxjs@_fapjxyjpwbhfwhmqy3rhk5heby/node_modules/@namnguyen191/dui-carbon-components/fesm2022/namnguyen191-dui-carbon-components.mjs
var DuiCarbonComponentLoader = {
  CARBON_BUTTON: () => import("./chunk-XU7R7LMZ.js").then((m) => m.CarbonButtonComponent),
  CARBON_TABLE: () => import("./chunk-HFZTRVRD.js").then((m) => m.CarbonTableComponent),
  CARBON_TEXT_CARD: () => import("./chunk-LRWTGJP4.js").then((m) => m.CarbonTextCardComponent)
};

// src/app/dui-config.ts
var getDUIConfigFactory = () => {
...
var appConfig = {
  providers: [
    ...
    provideHttpClient(),
    {
      ...
      useValue: new Worker(new URL("worker-RJUK4KEA.js", import.meta.url), {
        name: "worker",
        type: "module"
      })
    },
...
var _eventsService, _AppComponent_instances, setupResizeListener_fn;
var _AppComponent = class _AppComponent {
  constructor() {
    __privateAdd(this, _AppComponent_instances);
    __privateAdd(this, _eventsService, inject(EventsService));
    setupDefaultDUI();
    __privateMethod(this, _AppComponent_instances, setupResizeListener_fn).call(this);
  }
};
_eventsService = new WeakMap();
_AppComponent_instances = new WeakSet();
setupResizeListener_fn = function() {
  __privateGet(this, _eventsService).getEvents().pipe(UIElementRepositionEvent(), takeUntilDestroyed()).subscribe({
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 7, vars: 1, consts: [["cdsTheme", "g100"], ["brand", "Shrimping around"], [3, "isCurrentPage"], [1, "main-content"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "cds-header", 1)(2, "cds-header-navigation")(3, "cds-header-item", 2);
    \u0275\u0275text(4, "Home");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275property("isCurrentPage", true);
  }
}, dependencies: [RouterModule, RouterOutlet, ThemeModule, ThemeDirective, HeaderModule, Header, HeaderItem, HeaderNavigation], styles: ["\n\n[_nghost-%COMP%]   .main-content[_ngcontent-%COMP%] {\n  margin-top: 3rem;\n  padding: 0.5rem 2.5rem;\n  min-height: calc(100vh - 3rem);\n}\n[_nghost-%COMP%]     gridster-item {\n  background-color: var(--cds-background);\n}"] });
